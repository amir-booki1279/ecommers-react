              ...
              <tbody className="text-[#d0d2d6] ">
               
                 {
                  [1,2,3,4,5].map((d,i)=>(
                      ...
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap">Amir</td>
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap">amir@gmail.com</td>
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap">Inactive</td>
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap">Pending</td>

                     
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap">
                       <div className="flex justify-start items-center gap-4">
                         <Link to={'/admin-dashboard/seller-details/2'} className="p-1.5 bg-green-600 rounded 
