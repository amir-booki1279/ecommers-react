...
const DeActivedSeller = () => {
    ...
    return (
        <div className='px-4 lg:px-7 pt-5'>
                ...
                <h1 className='text-[20px] font-bold mb-3 '>Deactived Seller</h1>
              ...
              <tbody className="text-[#d0d2d6] ">
               
                 {
                  [1,2,3,4,5].map((d,i)=>(
                      ...
                      <td scope="row" className="py-1 px-4 font-normal whitespace-nowrap">Amir</td>
                      ...
                      <td scope="row" className="py-1 px-4 font-normal whitespace-nowrap">Deactive</td>
...
export default DeActivedSeller;